...
class _RequestServiceScreenState extends State<RequestServiceScreen> {
      ...
      body: Column(children: [
        ...
        Expanded(child: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Expanded(child: _timeBtn(false, Icons.access_time_outlined, 'Now')),
              const SizedBox(width: 10),
              Expanded(child: _timeBtn(true, Icons.calendar_today_outlined, 'Schedule')),
            ]),
            if (_scheduleMode) ...[
              const SizedBox(height: 14),
            ...
            const SizedBox(height: 20),
            PrimaryButton(text: 'Continue to Payment', color: AppColors.teal,
              onTap: () => Navigator.pushNamed(context, '/payment', arguments: provider)),
          ]),
        )),
      ]),
    );
  ...
  Widget _mapPlaceholder() => GestureDetector(
    onTap: () {},
    child: Container(
      width: double.infinity, height: 155, margin: const EdgeInsets.only(bottom: 18),
  ...
  Widget _timeBtn(bool isSchedule, IconData icon, String label) {
    ...
    return GestureDetector(
      onTap: () => setState(() => _scheduleMode = isSchedule),
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: sel ? AppColors.teal.withOpacity(0.07) : Colors.white,
        ),
